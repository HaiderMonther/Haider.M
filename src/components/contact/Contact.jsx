              ...
              <h3 className="contact__title">Talk to me</h3>
                ...
                <div className="contact__info">
                    <div className="contact__card">
                        ...
                        <span className="contact__card-data">haider223ds@outlook.com</span>

                        <a href="mailto:haider223ds@outlook.com" className="contact__button">Write me{"  "} 
                    ...
                    <i className='bx bxl-whatsapp contact__card-icon'></i>
                        ...
                        <span className="contact__card-data">964-783-706-9667</span>

                        <a href="https://api.whatsapp.com/send?phone=9647837069667&text=Hello, more information!" className="contact__button">Write me{"  "} 
                        <i className="bx bx-right-arrow-alt contact__button-icon"></i></a>
                    </div>


                    <div className="contact__card">
                    <i class='bx bxl-pinterest contact__card-icon'></i>

                        <h3 className="contact__card-title">Pinterest</h3>
                        <span className="contact__card-data">@alardyhydr567890</span>

                        <a href="https://www.pinterest.com/alardyhydr56789" className="contact__button">Write me{"  "} 
                        <i className="bx bx-right-arrow-alt contact__button-icon"></i></a>
                    </div>
                </div>
            </div>
                 ...
                 Send Message
                    <svg
                        ...
                        <path
                            ...
                            9.54518 13.93 9.54518 14.22 9.83518C14.51 10.1252 
